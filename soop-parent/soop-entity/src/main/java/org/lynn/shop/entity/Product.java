...
public class Product implements Serializable {
    ...
    public void setMerchants_code(String merchants_code) {
        this.merchants_code = merchants_code == null ? null : merchants_code.trim();
    }
    ...
    public String toString() {
        ...
        sb.append(", is_zero_interest=").append(is_zero_interest);
        sb.append(", is_zero_downpayment=").append(is_zero_downpayment);
