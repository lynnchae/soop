...
public class OrderStatusHistory implements Serializable {
    ...
    public void setTo_status(String to_status) {
        this.to_status = to_status == null ? null : to_status.trim();
    }
    ...
    public void setFrom_status(String from_status) {
        this.from_status = from_status == null ? null : from_status.trim();
    }
    ...
    public String toString() {
        ...
        sb.append(", to_status=").append(to_status);
        sb.append(", from_status=").append(from_status);
