...
public class VerificationCode implements Serializable {
    ...
    private String business_ref_no;
    ...
    public void setKey_number(String key_number) {
        this.key_number = key_number == null ? null : key_number.trim();
    }
    ...
    public String getBusiness_ref_no() {
        return business_ref_no;
    }

    public void setBusiness_ref_no(String business_ref_no) {
        this.business_ref_no = business_ref_no == null ? null : business_ref_no.trim();
    }
    ...
    public String toString() {
        ...
        sb.append(", key_number=").append(key_number);
        sb.append(", code=").append(code);
        sb.append(", expired_at=").append(expired_at);
        sb.append(", business_ref_no=").append(business_ref_no);
