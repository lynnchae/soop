...
import org.lynn.soop.entity.ProductBrandExample.Criteria;
import org.lynn.soop.entity.ProductBrandExample.Criterion;
import org.lynn.soop.entity.ProductBrandExample;
import java.util.List;

public class ProductBrandSqlProvider {

    public String countByExample(ProductBrandExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("`product_brand`");
    ...
    public String selectByExample(ProductBrandExample example) {
        BEGIN();
    ...
    protected void applyWhere(ProductBrandExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
