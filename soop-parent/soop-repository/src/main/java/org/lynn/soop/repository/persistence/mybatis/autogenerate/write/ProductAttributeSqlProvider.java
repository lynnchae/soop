...
import org.lynn.soop.entity.ProductAttributeExample.Criteria;
import org.lynn.soop.entity.ProductAttributeExample.Criterion;
import org.lynn.soop.entity.ProductAttributeExample;
import java.util.List;
import java.util.Map;

public class ProductAttributeSqlProvider {

    public String deleteByExample(ProductAttributeExample example) {
        BEGIN();
    ...
    public String insertSelective(ProductAttribute record) {
        BEGIN();
        ...
        if (record.getAttr_name() != null) {
            VALUES("`attr_name`", "#{attr_name,jdbcType=VARCHAR}");
        }
        
        if (record.getAttr_value() != null) {
            VALUES("`attr_value`", "#{attr_value,jdbcType=VARCHAR}");
        }
        
        if (record.getAttr_type() != null) {
            VALUES("`attr_type`", "#{attr_type,jdbcType=VARCHAR}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ProductAttribute record = (ProductAttribute) parameter.get("record");
        ProductAttributeExample example = (ProductAttributeExample) parameter.get("example");
        ...
        if (record.getAttr_name() != null) {
            SET("`attr_name` = #{record.attr_name,jdbcType=VARCHAR}");
        }
        
        if (record.getAttr_value() != null) {
            SET("`attr_value` = #{record.attr_value,jdbcType=VARCHAR}");
        }
        
        if (record.getAttr_type() != null) {
            SET("`attr_type` = #{record.attr_type,jdbcType=VARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(ProductAttribute record) {
        BEGIN();
        UPDATE("`product_attribute`");
        ...
        if (record.getAttr_name() != null) {
            SET("`attr_name` = #{attr_name,jdbcType=VARCHAR}");
        }
        
        if (record.getAttr_value() != null) {
            SET("`attr_value` = #{attr_value,jdbcType=VARCHAR}");
        }
        
        if (record.getAttr_type() != null) {
            SET("`attr_type` = #{attr_type,jdbcType=VARCHAR}");
        }
    ...
    protected void applyWhere(ProductAttributeExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
