...
import org.lynn.soop.entity.UsersooppingCartExample.Criteria;
import org.lynn.soop.entity.UsersooppingCartExample.Criterion;
import org.lynn.soop.entity.UsersooppingCartExample;
import java.util.List;
import java.util.Map;

public class UsersooppingCartSqlProvider {

    public String deleteByExample(UsersooppingCartExample example) {
        BEGIN();
        DELETE_FROM("`user_soopping_cart`");
        applyWhere(example, false);
        return SQL();
    }

    public String insertSelective(UsersooppingCart record) {
        BEGIN();
        INSERT_INTO("`user_soopping_cart`");
        ...
        if (record.getDate_expired() != null) {
            VALUES("`date_expired`", "#{date_expired,jdbcType=TIMESTAMP}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        UsersooppingCart record = (UsersooppingCart) parameter.get("record");
        UsersooppingCartExample example = (UsersooppingCartExample) parameter.get("example");
        ...
        if (record.getDate_expired() != null) {
            SET("`date_expired` = #{record.date_expired,jdbcType=TIMESTAMP}");
        }
    ...
    public String updateByPrimaryKeySelective(UsersooppingCart record) {
        BEGIN();
        UPDATE("`user_soopping_cart`");
        ...
        if (record.getDate_expired() != null) {
            SET("`date_expired` = #{date_expired,jdbcType=TIMESTAMP}");
        }
    ...
    protected void applyWhere(UsersooppingCartExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
