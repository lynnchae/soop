...
public class AdminStatisticSqlProvider {
    ...
    public String countByExample(AdminStatisticExample example) {
        BEGIN();
        SELECT("count(*)");
    ...
    public String selectByExample(AdminStatisticExample example) {
        BEGIN();
        ...
        SELECT("`total_product_count_in_stock`");
        SELECT("`total_hot_product_count`");
        SELECT("`total_new_product_count`");
        SELECT("`total_promo_product_count`");
        SELECT("`total_order_count`");
        SELECT("`pending_delivery_order_count`");
        SELECT("`pending_pay_order_count`");
        SELECT("`done_order_count`");
        SELECT("`refund_order_count`");
        SELECT("`total_user_online`");
        FROM("`admin_statistic`");
        applyWhere(example, false);
