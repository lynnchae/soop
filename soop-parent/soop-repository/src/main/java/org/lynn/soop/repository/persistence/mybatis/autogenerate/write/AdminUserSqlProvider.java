...
import org.lynn.soop.entity.AdminUserExample.Criteria;
import org.lynn.soop.entity.AdminUserExample.Criterion;
...
public class AdminUserSqlProvider {
    ...
    public String insertSelective(AdminUser record) {
        ...
        if (record.getLogin_account() != null) {
            VALUES("`login_account`", "#{login_account,jdbcType=VARCHAR}");
        }
        ...
        if (record.getSession_expired() != null) {
            VALUES("`session_expired`", "#{session_expired,jdbcType=TIMESTAMP}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getLogin_account() != null) {
            SET("`login_account` = #{record.login_account,jdbcType=VARCHAR}");
        }
        ...
        if (record.getSession_expired() != null) {
            SET("`session_expired` = #{record.session_expired,jdbcType=TIMESTAMP}");
        }
    ...
    public String updateByPrimaryKeySelective(AdminUser record) {
        ...
        if (record.getLogin_account() != null) {
            SET("`login_account` = #{login_account,jdbcType=VARCHAR}");
        }
        ...
        if (record.getSession_expired() != null) {
            SET("`session_expired` = #{session_expired,jdbcType=TIMESTAMP}");
        }
