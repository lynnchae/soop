...
import org.lynn.soop.entity.StockExample.Criteria;
import org.lynn.soop.entity.StockExample.Criterion;
...
public class StockSqlProvider {
    ...
    protected void applyWhere(StockExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
