...
public class OrderDeliverySqlProvider {
    ...
    public String countByExample(OrderDeliveryExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("`order_delivery`");
    ...
    public String selectByExampleWithBLOBs(OrderDeliveryExample example) {
        BEGIN();
        ...
        SELECT("`date_updated`");
        SELECT("`updated_by`");
        SELECT("`source_delivery_route`");
        SELECT("`order_id`");
        SELECT("`delivery_address`");
        SELECT("`delivery_post_code`");
        SELECT("`delivery_contact_name`");
        SELECT("`delivery_contact_phone`");
        SELECT("`status`");
        ...
        SELECT("`delivery_fee`");
        SELECT("`batch_no`");
        SELECT("`delivery_detail_status_list`");
        FROM("`order_delivery`");
        applyWhere(example, false);
    ...
    public String selectByExample(OrderDeliveryExample example) {
        BEGIN();
        if (example != null && example.isDistinct()) {
            SELECT_DISTINCT("`id`");
        } else {
