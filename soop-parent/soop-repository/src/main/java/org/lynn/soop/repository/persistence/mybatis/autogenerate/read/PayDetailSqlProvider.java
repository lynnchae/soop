...
public class PayDetailSqlProvider {
    ...
    public String countByExample(PayDetailExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("`pay_detail`");
    ...
    public String selectByExampleWithBLOBs(PayDetailExample example) {
        BEGIN();
    ...
    public String selectByExample(PayDetailExample example) {
        BEGIN();
        if (example != null && example.isDistinct()) {
            SELECT_DISTINCT("`id`");
        } else {
