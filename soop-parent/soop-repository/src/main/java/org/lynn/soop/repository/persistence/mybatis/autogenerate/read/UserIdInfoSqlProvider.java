...
public class UserIdInfoSqlProvider {
    ...
    public String countByExample(UserIdInfoExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("`user_id_info`");
    ...
    public String selectByExample(UserIdInfoExample example) {
        BEGIN();
        ...
        SELECT("`updated_by`");
        SELECT("`user_id`");
        SELECT("`id_front_image`");
        SELECT("`id_back_image`");
        FROM("`user_id_info`");
        applyWhere(example, false);
