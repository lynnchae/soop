...
public class OrderProductListSqlProvider {
    ...
    public String countByExample(OrderProductListExample example) {
        BEGIN();
        SELECT("count(*)");
    ...
    public String selectByExample(OrderProductListExample example) {
        BEGIN();
        ...
        SELECT("`order_status`");
        SELECT("`pay_complete_time`");
        SELECT("`purchase_complete_time`");
        FROM("`order_product_list`");
        applyWhere(example, false);
