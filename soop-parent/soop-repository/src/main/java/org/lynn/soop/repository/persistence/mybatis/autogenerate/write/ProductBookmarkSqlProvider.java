...
import org.lynn.soop.entity.ProductBookmarkExample.Criteria;
import org.lynn.soop.entity.ProductBookmarkExample.Criterion;
import org.lynn.soop.entity.ProductBookmarkExample;
import java.util.List;
import java.util.Map;

public class ProductBookmarkSqlProvider {

    public String deleteByExample(ProductBookmarkExample example) {
        BEGIN();
        DELETE_FROM("`product_bookmark`");
        applyWhere(example, false);
        return SQL();
    }

    public String insertSelective(ProductBookmark record) {
        BEGIN();
        INSERT_INTO("`product_bookmark`");
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ProductBookmark record = (ProductBookmark) parameter.get("record");
        ProductBookmarkExample example = (ProductBookmarkExample) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(ProductBookmark record) {
        BEGIN();
        UPDATE("`product_bookmark`");
    ...
    protected void applyWhere(ProductBookmarkExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
