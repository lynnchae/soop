...
public class ProductBrandSqlProvider {
    ...
    public String deleteByExample(ProductBrandExample example) {
        BEGIN();
        DELETE_FROM("`product_brand`");
        applyWhere(example, false);
        return SQL();
    }

    public String insertSelective(ProductBrand record) {
        BEGIN();
        INSERT_INTO("`product_brand`");
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ProductBrand record = (ProductBrand) parameter.get("record");
        ProductBrandExample example = (ProductBrandExample) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(ProductBrand record) {
        BEGIN();
        UPDATE("`product_brand`");
