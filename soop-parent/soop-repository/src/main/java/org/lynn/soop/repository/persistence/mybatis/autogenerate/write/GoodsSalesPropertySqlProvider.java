...
import org.lynn.soop.entity.GoodsSalesPropertyExample.Criteria;
import org.lynn.soop.entity.GoodsSalesPropertyExample.Criterion;
...
public class GoodsSalesPropertySqlProvider {

    public String deleteByExample(GoodsSalesPropertyExample example) {
        BEGIN();
        DELETE_FROM("`goods_sales_property`");
        applyWhere(example, false);
        return SQL();
    }

    public String insertSelective(GoodsSalesProperty record) {
        BEGIN();
        INSERT_INTO("`goods_sales_property`");
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        GoodsSalesProperty record = (GoodsSalesProperty) parameter.get("record");
        GoodsSalesPropertyExample example = (GoodsSalesPropertyExample) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(GoodsSalesProperty record) {
        BEGIN();
        UPDATE("`goods_sales_property`");
    ...
    protected void applyWhere(GoodsSalesPropertyExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
