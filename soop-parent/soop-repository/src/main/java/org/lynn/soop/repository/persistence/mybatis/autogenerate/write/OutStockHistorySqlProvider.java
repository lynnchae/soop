...
import org.lynn.soop.entity.OutStockHistoryExample.Criteria;
import org.lynn.soop.entity.OutStockHistoryExample.Criterion;
import org.lynn.soop.entity.OutStockHistoryExample;
import java.util.List;
import java.util.Map;

public class OutStockHistorySqlProvider {

    public String deleteByExample(OutStockHistoryExample example) {
        BEGIN();
        DELETE_FROM("`out_stock_history`");
        applyWhere(example, false);
        return SQL();
    }

    public String insertSelective(OutStockHistory record) {
        BEGIN();
        INSERT_INTO("`out_stock_history`");
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        OutStockHistory record = (OutStockHistory) parameter.get("record");
        OutStockHistoryExample example = (OutStockHistoryExample) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(OutStockHistory record) {
        BEGIN();
        UPDATE("`out_stock_history`");
    ...
    protected void applyWhere(OutStockHistoryExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
