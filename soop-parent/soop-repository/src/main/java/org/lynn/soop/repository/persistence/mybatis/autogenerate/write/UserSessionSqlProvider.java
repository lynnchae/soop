...
import org.lynn.soop.entity.UserSessionExample.Criteria;
import org.lynn.soop.entity.UserSessionExample.Criterion;
...
public class UserSessionSqlProvider {
    ...
    public String deleteByExample(UserSessionExample example) {
        BEGIN();
        DELETE_FROM("`user_session`");
    ...
    public String insertSelective(UserSession record) {
        ...
        if (record.getSession_id() != null) {
            VALUES("`session_id`", "#{session_id,jdbcType=VARCHAR}");
        }
        ...
        if (record.getIs_valid() != null) {
            VALUES("`is_valid`", "#{is_valid,jdbcType=BIT}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        UserSession record = (UserSession) parameter.get("record");
        UserSessionExample example = (UserSessionExample) parameter.get("example");
        ...
        if (record.getSession_id() != null) {
            SET("`session_id` = #{record.session_id,jdbcType=VARCHAR}");
        }
        ...
        if (record.getIs_valid() != null) {
            SET("`is_valid` = #{record.is_valid,jdbcType=BIT}");
        }
    ...
    public String updateByPrimaryKeySelective(UserSession record) {
        ...
        if (record.getSession_id() != null) {
            SET("`session_id` = #{session_id,jdbcType=VARCHAR}");
        }
        ...
        if (record.getIs_valid() != null) {
            SET("`is_valid` = #{is_valid,jdbcType=BIT}");
        }
    ...
    protected void applyWhere(UserSessionExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
