...
import org.lynn.soop.entity.PayConfigExample.Criteria;
import org.lynn.soop.entity.PayConfigExample.Criterion;
import org.lynn.soop.entity.PayConfigExample;
import java.util.List;
import java.util.Map;

public class PayConfigSqlProvider {

    public String deleteByExample(PayConfigExample example) {
        BEGIN();
        DELETE_FROM("`pay_config`");
        applyWhere(example, false);
        return SQL();
    }

    public String insertSelective(PayConfig record) {
        BEGIN();
        INSERT_INTO("`pay_config`");
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        PayConfig record = (PayConfig) parameter.get("record");
        PayConfigExample example = (PayConfigExample) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(PayConfig record) {
        BEGIN();
        UPDATE("`pay_config`");
    ...
    protected void applyWhere(PayConfigExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
